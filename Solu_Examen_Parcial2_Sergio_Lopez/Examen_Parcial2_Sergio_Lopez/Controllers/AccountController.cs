...
using Examen_Parcial2_Sergio_Lopez.Models;
using Examen_Parcial2_Sergio_Lopez.Providers;
using Examen_Parcial2_Sergio_Lopez.Results;

namespace Examen_Parcial2_Sergio_Lopez.Controllers
{
    [Authorize]
